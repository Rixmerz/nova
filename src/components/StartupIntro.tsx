...
import novaLogo from "../../src-tauri/icons/icon.png";
      ...
      {visible && (
        ...
        >
          ...
          >
            ...
            {/* Nova logo slides left; brand text reveals to the right */}
...
function BrandText() {
  return (
    <div className="text-5xl font-extrabold tracking-tight brand-text">
      <span className="brand-text-solid">Nova</span>
      <span aria-hidden="true" className="brand-text-shimmer">Nova</span>
    </div>
  );
}
